...
<section className="max-w-screen-lg mx-auto py-12 px-6 font-sans">
  ...
  [//]: # (UI polish) Note and CTA
  <p className="text-lg text-gray-700 leading-relaxed mb-8">_All packages are customizable. Contact us for a quote!_</p>
