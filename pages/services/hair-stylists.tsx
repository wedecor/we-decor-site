    ...
    <>
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                'Professional hair styling for events in Bangalore: cuts, colors, braids, and more. Latest trends and flexible service.',
              provider: {
                '@type': 'Organization',
                name: 'We Decor',
      ...
      <Layout
        seo={{
          ...
          description:
            'We Decor offers professional hair styling for events in Bangalore: cuts, colors, braids, and more. Latest trends and flexible service.',
        }}
      >
        <section className="max-w-screen-lg mx-auto py-12 px-6 font-sans">
          ...
          <p className="text-lg text-gray-800 dark:text-white leading-relaxed mb-8">
            Our expert hair stylists offer a wide range of services to help you achieve the perfect
            look for any event. We use the latest tools and trends to ensure your hair is styled to
            perfection.
          </p>
          ...
          <p className="text-gray-800 dark:text-white mb-8">
            From classic cuts to creative styles, our team will work with you to create a look that
            matches your personality and the occasion.
          </p>
