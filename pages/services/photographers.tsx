    ...
    <>
      ...
      >
        <section className="max-w-screen-lg mx-auto py-12 px-6 font-sans">
          ...
          <p className="text-lg text-gray-800 dark:text-white leading-relaxed mb-8">Our professional photographers capture your most important moments with creativity and care. We offer a range of photography services for every occasion.</p>
          ...
          <p className="text-gray-800 dark:text-white mb-8">From candid moments to posed portraits, we ensure every memory is beautifully preserved for you to cherish.</p>
