    ...
    <>
      ...
      >
        <section className="max-w-screen-lg mx-auto py-12 px-6 font-sans">
          ...
          <p className="text-lg text-gray-800 dark:text-white leading-relaxed mb-8">Our skilled mehndi artists create beautiful, intricate designs for all occasions. We offer a variety of styles to suit your preferences and event theme.</p>
          ...
          <p className="text-gray-800 dark:text-white mb-8">Let us adorn your hands and feet with stunning mehndi art that will be remembered long after your event is over.</p>
