          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col h-full">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-base mb-4">{service.description}</p>
                <div className="mt-auto flex items-center justify-end">
                  <span className="text-green-600 dark:text-green-300 font-semibold mr-2">Learn More</span>
                  <FaArrowRight className="text-green-600 dark:text-green-300 group-hover:translate-x-1 transition-transform duration-200" aria-hidden="true" />
                </div>
              </div>
            </Link>
          ))}
