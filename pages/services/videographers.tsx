    ...
    <>
      ...
      >
        <section className="max-w-screen-lg mx-auto py-12 px-6 font-sans">
          ...
          <p className="text-lg text-gray-800 dark:text-white leading-relaxed mb-8">Our talented videographers create dynamic, impactful videos for all types of events. We use the latest equipment and techniques to capture every important moment.</p>
          ...
          <p className="text-gray-800 dark:text-white mb-8">Let us tell your story through cinematic video that you and your guests will enjoy for years to come.</p>
