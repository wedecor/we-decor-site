    ...
    <>
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                'Professional make-up artists for weddings, parties, and events in Bangalore. Latest trends, top brands, and creative looks.',
              provider: {
                '@type': 'Organization',
                name: 'We Decor',
      ...
      <Layout
        seo={{
          ...
          description:
            'We Decor provides professional make-up artists for weddings, parties, and events in Bangalore. Latest trends, top brands, and creative looks.',
        }}
      >
        <section className="max-w-screen-lg mx-auto py-12 px-6 font-sans">
          ...
          <p className="text-lg text-gray-800 dark:text-white leading-relaxed mb-8">
            Our professional make-up artists help you look your best for any occasion. We use top
            brands and the latest techniques to create stunning looks that match your style and
            event.
          </p>
          ...
          <p className="text-gray-800 dark:text-white mb-8">
            Whether you want a natural glow or a glamorous transformation, our artists will ensure
            you feel confident and beautiful for your big day or special event.
          </p>
