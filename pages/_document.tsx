  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="We Decor – Bangalore's trusted wedding and event decorators. Elegant haldi, birthday, and stage decor starting from ₹2999."
        />
        ...
        <meta
          ...
          content="Bangalore's trusted decor experts for weddings, birthdays, haldi, and more. Professional event decoration services starting from ₹2999."
        />
        ...
        <meta
          ...
          content="Bangalore's trusted decor experts for weddings, birthdays, haldi, and more."
        />
        ...
        <meta
          name="keywords"
          content="wedding decoration, birthday decoration, haldi decoration, event decorators, Bangalore decorators, stage decoration, tent setup, balloon decoration"
        />
