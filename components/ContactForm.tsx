    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="text-center">
        ...
        <a
          ...
          className="inline-flex items-center justify-center rounded-lg px-4 py-2 text-white bg-emerald-800 hover:bg-emerald-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-emerald-500 font-semibold"
        >
