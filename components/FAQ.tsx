...
export default function FAQ() {
  return (
    <section className="max-w-4xl mx-auto py-14 md:py-16 px-6 bg-[#faf7f2] dark:bg-[#1e3a5f] rounded-2xl shadow-[0_20px_60px_rgba(15,61,62,0.1)] border border-[#1e3a5f14]">
      <div className="text-center mb-12">
        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-[#1e3a5f] dark:text-[#faf7f2]">
          Frequently Asked Questions
        </h2>
        <p className="text-lg text-[#1e3a5f]/80 dark:text-[#faf7f2]/80">
      ...
      <div className="space-y-4">
        {faqs.map((faq, index) => (
          <Disclosure key={index}>
            {({ open }) => (
              <div className="bg-white dark:bg-[#162544] rounded-xl shadow-[0_10px_30px_rgba(15,61,62,0.08)] border border-[#1e3a5f14]">
                <Disclosure.Button className="flex w-full justify-between items-center px-6 py-4 text-left hover:bg-[#b76e7a14] dark:hover:bg-white/5 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#b76e7a]/50 rounded-t-xl">
                  <span className="text-lg font-semibold text-[#1e3a5f] dark:text-[#faf7f2]">
                    {faq.question}
                  </span>
                  <ChevronDownIcon
                    className={`${open ? 'transform rotate-180' : ''} w-5 h-5 text-[#b76e7a] transition-transform duration-200`}
                  />
                </Disclosure.Button>
                <Transition
                ...
                >
                  <Disclosure.Panel className="px-6 pb-4">
                    <p className="text-[#1e3a5f]/80 dark:text-[#faf7f2]/80 leading-relaxed">
                      {faq.answer}
                    </p>
                  </Disclosure.Panel>
                </Transition>
      ...
      <div className="text-center mt-8">
        <p className="text-[#1e3a5f]/80 dark:text-[#faf7f2]/70 mb-4">Still have questions?</p>
        <a
          href="https://wa.me/918880544452"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center px-6 py-3 rounded-full font-semibold bg-[#b76e7a] text-[#1e3a5f] hover:bg-[#c98a94] transition-all duration-300 shadow-[0_8px_30px_rgba(183,110,122,0.35)] focus:outline-none focus:ring-2 focus:ring-[#b76e7a]/60"
        >
