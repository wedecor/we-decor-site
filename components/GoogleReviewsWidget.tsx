      ...
      <div className="lux-panel p-8 md:p-10">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          <div className="flex items-center">
            <svg className="w-8 h-8 text-lux-gold mr-2" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm text-lux-text-muted">5.0 (50+ reviews)</span>
          </div>
        </div>

        <p className="lux-body text-sm mb-8">
          Read authentic reviews from our customers on Google.
        </p>
