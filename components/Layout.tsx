  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 bg-gradient-to-r from-green-500 to-blue-500 text-white px-6 py-3 rounded-full shadow-xl z-50 flex items-center gap-3 hover:scale-105 transition transform duration-200 animate-pulse hover:shadow-2xl"
        target="_blank"
        rel="noopener"
        id="whatsapp-cta"
      ...
      <a
        ...
        className="fixed bottom-24 right-6 bg-gradient-to-r from-blue-600 to-green-500 text-white px-6 py-3 rounded-full shadow-xl z-50 flex items-center gap-3 hover:scale-105 transition transform duration-200 animate-pulse hover:shadow-2xl"
        id="callnow-cta"
