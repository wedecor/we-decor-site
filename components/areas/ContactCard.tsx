  ...
  return (
    <section className="mb-10 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 bg-white dark:bg-gray-800 shadow-sm">
      ...
      <div className="mt-4 flex flex-wrap gap-3">
        <a className="rounded-xl px-4 py-2 border border-green-200 dark:border-green-700 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors" href={`tel:${phone}`}>Call Now</a>
