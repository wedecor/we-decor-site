    ...
    <nav className="fixed top-0 left-0 w-full bg-gradient-to-r from-green-100 via-pink-100 to-blue-100 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 shadow-lg z-40 font-sans backdrop-blur-md">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <Link href="/" className="flex items-center gap-2 group focus:outline-none focus:ring-2 focus:ring-green-500 rounded">
          ...
          <span className="font-bold text-2xl text-green-700 dark:text-green-200 tracking-wide group-hover:text-pink-500 dark:group-hover:text-pink-300 transition">We Decor</span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="/areas" className="px-4 py-2 text-green-700 dark:text-green-200 font-medium rounded hover:bg-green-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-green-400 transition">Areas</Link>
        ...
        <div className="md:hidden flex items-center gap-3">
          <DarkModeToggle />
          <button className="text-green-700 dark:text-green-200 focus:outline-none focus:ring-2 focus:ring-green-400 rounded" onClick={() => setOpen(!open)}>
        ...
        >
          ...
          <Link href="/areas" className="px-4 py-2 text-green-700 dark:text-green-200 font-medium hover:bg-green-50 dark:hover:bg-gray-800 rounded transition">Areas</Link>
