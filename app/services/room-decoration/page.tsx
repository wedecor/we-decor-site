...
export const metadata: Metadata = {
  title: 'Room Decoration Services in Bangalore | We Decor',
  description:
    'Transform any space with our room decoration services in Bangalore. From intimate gatherings to large celebrations.',
  openGraph: {
    title: 'Room Decoration Services in Bangalore | We Decor',
    description: 'Transform any space with our room decoration services in Bangalore.',
    images: ['/services/room decor.jpg'],
  },
  twitter: {
  ...
  alternates: {
    canonical: '/services/room-decoration',
  },
};
      ...
      <div className="min-h-screen bg-[#faf7f2] dark:bg-[#1e3a5f]">
        <section className="bg-[#1e3a5f] text-white py-16">
          <div className="max-w-6xl mx-auto px-6 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Room Decoration Services</h1>
            <p className="text-xl md:text-2xl mb-8 text-white/95">
              Beautiful and personalized room decor for any occasion
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6 text-[#1e3a5f] dark:text-[#faf7f2]">
                  Why Choose Our Room Decorations?
                </h2>
                <ul className="space-y-4 text-lg text-[#1e3a5f]/90 dark:text-[#faf7f2]/90">
                  <li className="flex items-start">
                    <span className="text-[#b76e7a] mr-3">🏠</span>
                    Intimate and large space setups
                  </li>
                  <li className="flex items-start">
                    <span className="text-[#b76e7a] mr-3">🌸</span>
                    Backdrops, florals, and accent pieces
                  </li>
                  <li className="flex items-start">
                    <span className="text-[#b76e7a] mr-3">✨</span>
                    Themes tailored to your vision
                  </li>
                  <li className="flex items-start">
                    <span className="text-[#b76e7a] mr-3">📐</span>
                    Space-efficient layouts for any room
                  </li>
                </ul>
              </div>
              <div className="bg-white dark:bg-[#162544] rounded-2xl shadow-[0_8px_32px_rgba(26,77,62,0.06)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.2)] p-6 border border-[#1e3a5f]/10 dark:border-white/10">
                ...
                <p className="text-[#1e3a5f]/80 dark:text-[#faf7f2]/80 mb-6">
                  Contact us for a personalized room decoration quote
                </p>
                <a
                  href="/contact"
