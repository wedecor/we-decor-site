...
export const metadata: Metadata = {
  ...
  description: "Traditional and modern birthday, wedding, haldi & balloon decoration in Vijayanagar. Décor for community halls, homes and banquet venues. Book today.",
  alternates: { canonical: "https://www.wedecorevents.com/areas/vijayanagar" },
  openGraph: {
    title: "Event Decoration in Vijayanagar – We Decor Bangalore",
    description: "Traditional and modern birthday, wedding, haldi & balloon decoration in Vijayanagar. Décor for community halls, homes and banquet venues. Book today.",
    url: "https://www.wedecorevents.com/areas/vijayanagar",
    type: "article",
    siteName: "We Decor",
  },
  twitter: {
...
export default function Page() {
  ...
  const why = `✔ Local decorators in Vijayanagar with experience in temples, halls and modern venues.`;
  
  const nearby: {name: string; slug: string}[] = [
    { "name": "RPC Layout", "slug": "rpc-layout" },
    { "name": "Chandra Layout", "slug": "chandra-layout" },
