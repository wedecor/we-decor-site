...
export default function Page() {
  ...
  const why = `✔ Local decorators in Koramangala familiar with rooftop restaurants, banquet halls and heritage homes.`;
