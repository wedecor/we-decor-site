...
export default function Page() {
  ...
  const why = `✔ Local decorators in Sahakarnagar familiar with major banquet halls and gated communities.`;
  
  const nearby: {name: string; slug: string}[] = [
    { "name": "Hebbal", "slug": "hebbal" },
    { "name": "Kodigehalli", "slug": "kodigehalli" },
