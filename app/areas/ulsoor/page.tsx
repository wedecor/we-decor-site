...
export const metadata: Metadata = {
  ...
  description: "Birthday, wedding, haldi & balloon decoration in Ulsoor. Premium home, banquet & corporate event décor. Call now for quick booking.",
...
export default function Page() {
  ...
  const intro = `Looking for birthday, wedding, haldi or anniversary decoration in Ulsoor? At We Decor, we bring stunning décor to homes, apartments, villas, clubhouses and banquet halls across Ulsoor. From balloon backdrops to floral wedding stages, our team designs and sets up everything so you can enjoy stress-free celebrations.`;
  const services: string[] = [
  "Birthday Decoration in Ulsoor — Theme balloons, LED backdrops, kids’ parties, milestone birthdays.",
  "Wedding & Engagement Décor in Ulsoor — Floral mandaps, stage setups, bridal room décor.",
  "Haldi & Mehendi Decoration in Ulsoor — Yellow floral stage, marigold backdrop, traditional props.",
  "Balloon Decoration in Ulsoor — At home, clubhouses & banquet halls.",
  "Corporate Event Decoration in Ulsoor — Office parties, team events, festive décor."
];
  const why = `Local team covering all of Ulsoor. Quick setup at homes, apartments & community halls. Custom themes & budget-friendly packages.`;
