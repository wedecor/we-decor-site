...
export const metadata: Metadata = {
  ...
  description: "Professional birthday, wedding, haldi & balloon decoration in Basavanagudi. Décor for homes, apartments, banquet halls & rooftops. Book We Decor today.",
  alternates: { canonical: "https://www.wedecorevents.com/areas/basavanagudi" },
  openGraph: {
    title: "Event Decoration in Basavanagudi – We Decor Bangalore",
    description: "Professional birthday, wedding, haldi & balloon decoration in Basavanagudi. Décor for homes, apartments, banquet halls & rooftops. Book We Decor today.",
    url: "https://www.wedecorevents.com/areas/basavanagudi",
    type: "article",
    siteName: "We Decor",
  },
  twitter: {
...
export default function Page() {
  ...
  const why = `✔ Local Basavanagudi decorators available for quick same-day setups.`;
  
  const nearby: {name: string; slug: string}[] = [
    { "name": "Jayanagar", "slug": "jayanagar" },
    { "name": "Banashankari", "slug": "banashankari" },
    { "name": "Chamrajpet", "slug": "chamrajpet" }
  ];
