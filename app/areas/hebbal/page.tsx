...
export default function Page() {
  ...
  const why = `✔ Local decorators in Hebbal familiar with major banquet halls and gated communities.`;
  
  const nearby: {name: string; slug: string}[] = [
    { "name": "Yelahanka", "slug": "yelahanka" },
    { "name": "RT Nagar", "slug": "rt-nagar" },
    { "name": "Sahakarnagar", "slug": "sahakarnagar" }
  ];
