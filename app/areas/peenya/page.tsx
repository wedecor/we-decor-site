...
export const metadata: Metadata = {
  ...
  description: "Birthday, wedding, haldi & balloon decoration in Peenya. Premium home,",
...
Looking for birthday, wedding, haldi or anniversary decoration in Peenya? At We Decor, we bring
stunning décor to homes, apartments, villas, clubhouses and banquet halls across Peenya. From
...
enjoy stress-free celebrations.`;
  ...
  "n Birthday Decoration in Peenya — Theme balloons, LED backdrops, kids’ parties, milestone",
  "birthdays.",
  "n Wedding & Engagement Décor in Peenya — Floral mandaps, stage setups, bridal room décor.",
  "n Haldi & Mehendi Decoration in Peenya — Yellow floral stage, marigold backdrop, traditional",
  "props.",
  "n Balloon Decoration in Peenya — At home, clubhouses & banquet halls.",
  "n Corporate Event Decoration in Peenya — Office parties, team events, festive décor."
];
  const why = `4 Local team covering all of Peenya and nearby areas. 4 Quick setup at homes, apartments & community halls. 4 Custom themes & budget-friendly packages. 4 500+ events decorated in Bangalore.`;
  const nearby: {name: string; slug: string}[] = [];
  const faqs: {q: string; a: string}[] = [
  {
    "q": "Do you provide home birthday decoration?",
    "a": "Yes, we specialize in home and apartment decoration in Peenya — perfect for intimate family"
  },
  {
    "q": "Can you set up décor in banquet halls or clubhouses?",
    "a": "Absolutely! We’ve worked in several Peenya venues, apartments and community halls."
  },
  {
