...
export default function Page() {
  ...
  const why = `✔ Local decorators in Peenya with experience in temples, halls and modern venues.`;
  
  const nearby: {name: string; slug: string}[] = [
    { "name": "Yeshwanthpur", "slug": "yeshwanthpur" },
    { "name": "Jalahalli", "slug": "jalahalli" },
    { "name": "Dasarahalli", "slug": "dasarahalli" }
  ];
