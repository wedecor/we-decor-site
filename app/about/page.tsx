...
export default function AboutPage() {
  return (
    <section className="max-w-screen-lg mx-auto py-20 md:py-24 px-6">
      <h1 className={`${playfair.className} text-4xl md:text-5xl font-bold text-center mb-8 text-[#1e3a5f] dark:text-[#faf7f2]`}>
        About We Decor
      </h1>
      <p className={`${inter.className} text-lg text-[#1e3a5f]/80 dark:text-[#faf7f2]/80 leading-relaxed mb-8`}>
      ...
      <h2 className={`${playfair.className} text-2xl font-bold mb-4 text-[#1e3a5f] dark:text-[#faf7f2]`}>
      ...
      <h2 className={`${playfair.className} text-2xl font-bold mb-4 text-[#1e3a5f] dark:text-[#faf7f2]`}>Our Services</h2>
      <p className={`${inter.className} text-lg text-[#1e3a5f]/80 dark:text-[#faf7f2]/80 leading-relaxed mb-8`}>
      ...
      <div className="text-center">
        <Link
          href="/services"
          className="inline-block rounded-full px-8 py-4 font-semibold mt-4 bg-[#b76e7a] text-[#1e3a5f] hover:bg-[#c98a94] transition-all duration-300 shadow-[0_8px_30px_rgba(183,110,122,0.35)] hover:shadow-[0_12px_40px_rgba(183,110,122,0.45)]"
        >
