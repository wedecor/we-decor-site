/**
 * Per-locality SEO title + meta description (Phase 4).
 * Used only by locations/[slug] generateMetadata — not schema/body.
 */

export type LocalityPageMeta = { title: string; description: string };

export const LOCALITY_PAGE_META: Record<string, LocalityPageMeta> = {
  'ashok-nagar': {
    title: 'Naming-Day Calm for Ashok Nagar Church & Hall Rooms',
    description:
  ...
  banashankari: {
    title: 'One Palette from Banashankari Puja to Night Reception',
    description:
  ...
  bangalore: {
    title: 'Separate Installs for Every Bangalore Venue Pin Code',
    description:
  ...
  'bannerghatta-road': {
    title: 'Modular Botanicals for Bannerghatta Road Villa Lawns',
    description:
  ...
  basavanagudi: {
    title: 'Elder Paths & Soft Golds in Basavanagudi Lunch Halls',
    description:
  ...
  bellandur: {
    title: 'Handover-Slot Rooftops for Bellandur Condo Clubhouses',
    description:
  ...
  'btm-layout': {
    title: 'Silk Board Buffers for BTM Layout Rooftop Farewells',
    description:
  ...
  domlur: {
    title: 'Corridor-Clear Weeknights for Domlur Office Floors',
    description:
  ...
  'electronic-city': {
    title: 'Phase Freight Windows for Electronic City Villa Days',
    description:
  ...
  hebbal: {
    title: 'Dusk Lighting Plans for Hebbal Lakeside Clubhouses',
    description:
  ...
  'hsr-layout': {
    title: 'Apartment-Rule Birthdays on HSR Layout 27th Main Road',
    description:
  ...
  indiranagar: {
    title: 'Waiter-Path Centrepieces for Indiranagar Rooftop Nights',
    description:
  ...
  jayanagar: {
    title: 'Home Haldi Echoed into Jayanagar 4th Block Hall Nights',
    description:
  ...
  'jp-nagar': {
    title: 'Shared-Floor Pathways for JP Nagar Family Weekends',
    description:
  ...
  'kanakapura-road': {
    title: 'Stair-Width Checks Before Kanakapura Road Arches Rise',
    description:
  ...
  koramangala: {
    title: 'Café-Safe Anchors for Koramangala Rooftop Photo Sets',
    description:
  ...
  malleshwaram: {
    title: 'Stair-Turning Fabrics for Malleshwaram Temple Weeks',
    description:
  ...
  marathahalli: {
    title: 'Real Lift Minutes Before Marathahalli Balloon Height',
    description:
  ...
  mathikere: {
    title: 'Student Bright vs Elder Soft Beside Mathikere Lake',
    description:
  ...
  peenya: {
    title: 'After-Shift Neutrals for Peenya Workplace Gatherings',
    description:
  ...
  rajajinagar: {
    title: 'Orion Banquet Tone vs Rajajinagar Apartment Rituals',
    description:
  ...
  'richmond-town': {
    title: 'Cornice-Kind Florals for Richmond Town Formal Dinners',
    description:
  ...
  'rt-nagar': {
    title: 'RSVP-Growth Seating Plans Across RT Nagar Weekends',
    description:
  ...
  sahakarnagar: {
    title: 'Early-Lamp Pastels for Sahakarnagar Naming Evenings',
    description:
  ...
  'sarjapur-road': {
    title: 'Twin-Tower Lift Etiquette Along Sarjapur Road Lawns',
    description:
  ...
  ulsoor: {
    title: 'Lake-Breeze Ballast for Ulsoor Banquet Door Openings',
    description:
  ...
  vijayanagar: {
    title: 'Garland-to-Stage Clarity Through Vijayanagar Festivals',
    description:
  ...
  whitefield: {
    title: 'Garden Florals or ITPL Lines — Pick the Whitefield Room',
    description:
  ...
  yelahanka: {
    title: 'Outdoor Swatches First for Yelahanka Villa Mornings',
    description:
  ...
  yeshwanthpur: {
    title: 'Festive Hall Reds, Cooler Office Nights in Yeshwanthpur',
    description:
