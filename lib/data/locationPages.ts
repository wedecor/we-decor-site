...
export const locationPages: LocationPage[] = [
  {
    ...
    slug: 'whitefield',
    description:
      'Whitefield, a bustling tech hub in East Bangalore, is home to many young professionals and families who love celebrating special occasions. From corporate events to birthday parties, we bring creative decoration solutions to make every event memorable.',
    eventTypes: [
      'Birthday Decor',
      'Haldi Setup',
      'Room Decoration',
  ...
  },
  {
    ...
    slug: 'jayanagar',
    description:
      'Jayanagar, known for its cultural heritage and traditional values, is perfect for traditional celebrations. Our decoration services here blend modern aesthetics with cultural significance for weddings, haldi ceremonies, and family gatherings.',
    eventTypes: [
      'Wedding Decor',
      'Haldi Setup',
      'Traditional Events',
  ...
  },
  {
    ...
    slug: 'indiranagar',
    description:
      "Indiranagar, the heart of Bangalore's nightlife and culture, demands sophisticated and trendy decoration styles. We specialize in contemporary designs perfect for modern celebrations, corporate events, and stylish parties.",
    eventTypes: [
      'Modern Decor',
      'Corporate Events',
      'Birthday Parties',
  ...
  },
  {
    ...
    slug: 'koramangala',
    description:
      'Koramangala, a vibrant neighborhood with a mix of students and professionals, loves creative and budget-friendly decoration ideas. We offer innovative solutions for birthday parties, room decorations, and small gatherings.',
    eventTypes: [
      'Birthday Decor',
      'Room Decoration',
      'Student Parties',
  ...
  },
  {
    ...
    slug: 'hsr-layout',
    description:
      'HSR Layout, a rapidly developing area with modern apartments and young families, appreciates contemporary decoration styles. We provide elegant solutions for birthday parties, room makeovers, and family celebrations.',
    eventTypes: [
      'Birthday Decor',
      'Room Decoration',
      'Family Events',
  ...
  },
  {
    ...
    slug: 'rt-nagar',
    description:
      'RT Nagar, a peaceful residential area with a mix of traditional and modern families, values both cultural significance and contemporary style. Our decoration services here blend the best of both worlds for all types of celebrations.',
    eventTypes: [
      'Traditional Decor',
      'Wedding Setup',
      'Birthday Parties',
  ...
  },
  {
    ...
    slug: 'hebbal',
    description:
      'Hebbal, known for its lakes and peaceful environment, is perfect for outdoor celebrations and nature-themed decorations. We specialize in creating magical outdoor setups for birthdays, engagements, and family events.',
    eventTypes: [
      'Outdoor Decor',
      'Birthday Parties',
      'Engagement Setup',
  ...
  },
  {
    ...
    description:
      'Electronic City, the IT hub of Bangalore, hosts numerous corporate events and tech celebrations. We provide professional decoration services for office parties, tech meetups, and corporate celebrations with a modern touch.',
    eventTypes: [
      'Corporate Events',
      'Tech Parties',
      'Office Decor',
  ...
  },
  {
    ...
    slug: 'btm-layout',
    description:
      "BTM Layout, one of Bangalore's largest residential areas, is home to diverse communities who love celebrating life's special moments. We bring affordable yet beautiful decoration solutions perfect for birthday parties, family gatherings, and cultural celebrations.",
    eventTypes: [
      'Birthday Decor',
      'Family Events',
  ...
  },
  {
    ...
    slug: 'marathahalli',
    description:
      "Marathahalli, a major IT corridor with growing residential communities, demands modern and professional decoration services. We specialize in corporate events, tech celebrations, and contemporary home decorations that reflect the area's dynamic spirit.",
    eventTypes: [
      'Corporate Events',
      'Tech Celebrations',
      'Modern Decor',
  ...
  },
  {
    ...
    slug: 'bellandur',
    description:
      'Bellandur, a premium tech hub with high-end residential communities, appreciates sophisticated and luxury decoration styles. We provide exclusive decoration services for upscale events, corporate celebrations, and premium family gatherings.',
    eventTypes: [
      'Luxury Events',
  ...
  },
  {
    ...
    slug: 'sarjapur-road',
    description:
      "Sarjapur Road, known for its premium residential communities and international schools, demands elegant and sophisticated decoration styles. We specialize in creating beautiful setups for family celebrations, children's parties, and upscale events.",
    eventTypes: [
      'Family Celebrations',
      "Children's Parties",
      'Upscale Events',
  ...
  },
  {
    ...
    slug: 'domlur',
    description:
      "Domlur, a central area with a mix of residential and commercial spaces, appreciates versatile decoration styles. We provide flexible solutions for corporate events, family celebrations, and mixed-purpose gatherings that suit the area's diverse needs.",
    eventTypes: [
      'Corporate Events',
      'Family Celebrations',
      'Mixed Events',
  ...
  },
  {
    ...
    slug: 'ulsoor',
    description:
      'Ulsoor, a traditional area with lakes and cultural significance, values both heritage and modern aesthetics. Our decoration services here blend traditional elements with contemporary styles for weddings, cultural events, and family celebrations.',
    eventTypes: [
      'Traditional Decor',
      'Cultural Events',
      'Wedding Setup',
  ...
  },
  {
    ...
    slug: 'richmond-town',
    description:
      'Richmond Town, an upscale diplomatic area with international communities, demands sophisticated and elegant decoration styles. We provide premium services for diplomatic events, upscale parties, and international celebrations.',
    eventTypes: [
      'Diplomatic Events',
      'Upscale Parties',
  ...
  },
  {
    ...
    slug: 'ashok-nagar',
    description:
      "Ashok Nagar, a central residential area with good connectivity, appreciates practical yet beautiful decoration solutions. We offer versatile services for family events, birthday parties, and small gatherings that fit the area's practical lifestyle.",
    eventTypes: [
      'Family Events',
      'Birthday Parties',
      'Small Gatherings',
  ...
  },
  {
    ...
    slug: 'banashankari',
    description:
      'Banashankari, a traditional area with strong cultural roots, is perfect for traditional celebrations and cultural events. We specialize in creating authentic traditional decorations for haldi ceremonies, weddings, and cultural festivals.',
    eventTypes: [
      'Traditional Decor',
      'Cultural Events',
      'Haldi Ceremonies',
  ...
  },
  {
    ...
    slug: 'basavanagudi',
    description:
      "Basavanagudi, known for its temples and traditional architecture, values cultural authenticity in celebrations. Our decoration services here focus on traditional themes, religious ceremonies, and cultural events that honor the area's heritage.",
    eventTypes: [
      'Traditional Decor',
  ...
  },
  {
    ...
    slug: 'jp-nagar',
    description:
      "J.P. Nagar, a well-established residential area with good family demographics, appreciates family-oriented decoration styles. We provide comprehensive services for children's parties, family celebrations, and cultural events that bring families together.",
    eventTypes: [
      'Family Celebrations',
      "Children's Parties",
      'Cultural Events',
      'Family-Oriented Decor',
      'Educational Events',
  ...
  },
  {
    ...
    description:
      'Bannerghatta Road, a growing residential corridor with modern developments, demands contemporary and trendy decoration styles. We specialize in modern themes, contemporary designs, and innovative setups for tech-savvy families and young professionals.',
    eventTypes: [
      'Modern Themes',
  ...
  },
  {
    ...
    description:
      'Kanakapura Road, a developing residential area with natural surroundings, appreciates nature-inspired and eco-friendly decoration styles. We provide sustainable decoration solutions for outdoor events, nature-themed parties, and eco-conscious celebrations.',
    eventTypes: [
  ...
  },
  {
    ...
    slug: 'malleshwaram',
    description:
      'Malleshwaram, a traditional area with strong cultural heritage, values authentic traditional decoration styles. We specialize in creating genuine traditional setups for cultural events, religious ceremonies, and heritage celebrations.',
    eventTypes: [
      'Traditional Decor',
      'Cultural Events',
      'Religious Ceremonies',
  ...
  },
  {
    ...
    slug: 'rajajinagar',
    description:
      "Rajajinagar, a central area with good commercial and residential mix, appreciates versatile and practical decoration solutions. We provide flexible services for mixed events, commercial celebrations, and family gatherings that suit the area's diverse needs.",
    eventTypes: [
      'Mixed Events',
  ...
  },
  {
    ...
    slug: 'vijayanagar',
    description:
      "Vijayanagar, a peaceful residential area with good family demographics, values family-oriented and community-focused decoration styles. We provide comprehensive services for family celebrations, community events, and children's parties.",
    eventTypes: [
      'Family Celebrations',
      'Community Events',
      "Children's Parties",
  ...
  },
  {
    ...
    slug: 'yelahanka',
    description:
      'Yelahanka, an airport area with growing residential communities, appreciates modern and efficient decoration styles. We provide quick setup services for corporate events, airport-related celebrations, and modern family gatherings.',
    eventTypes: [
      'Corporate Events',
      'Airport Celebrations',
      'Modern Family Gatherings',
      'Quick Setup Decor',
      'Efficient Themes',
      'Modern Styles',
    ],
  ...
  },
  {
    ...
    slug: 'sahakarnagar',
    description:
      'Sahakarnagar, a quiet residential area with good family demographics, values peaceful and elegant decoration styles. We provide serene decoration solutions for family celebrations, intimate gatherings, and peaceful family events.',
    eventTypes: [
      'Family Celebrations',
      'Intimate Gatherings',
      'Peaceful Family Events',
      'Serene Decor',
      'Elegant Themes',
      'Quiet Celebrations',
    ],
  ...
  },
  {
    ...
    slug: 'mathikere',
    description:
      'Mathikere, a student area with educational institutions, appreciates creative and budget-friendly decoration styles. We provide innovative solutions for student parties, educational events, and creative celebrations that fit student budgets.',
    eventTypes: [
      'Student Parties',
      'Educational Events',
  ...
  },
  {
    ...
    slug: 'yeshwanthpur',
    description:
      'Yeshwanthpur, an industrial area with mixed residential communities, values practical and durable decoration styles. We provide robust decoration solutions for industrial events, corporate celebrations, and practical family gatherings.',
    eventTypes: [
      'Industrial Events',
      'Corporate Celebrations',
      'Practical Family Gatherings',
      'Robust Decor',
      'Durable Themes',
      'Industrial Styles',
    ],
  ...
  },
  {
    ...
    slug: 'peenya',
    description:
      'Peenya, a major industrial area with limited residential communities, focuses on industrial and corporate decoration needs. We provide specialized services for industrial events, corporate functions, and professional celebrations.',
    eventTypes: [
      'Industrial Events',
      'Corporate Functions',
  ...
  },
  {
    ...
    slug: 'nelamangala',
    description:
      'Nelamangala, an outskirts area with developing residential communities, appreciates simple and practical decoration styles. We provide basic decoration services for family events, small gatherings, and practical celebrations.',
    eventTypes: [
      'Family Events',
      'Small Gatherings',
