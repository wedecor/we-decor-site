...
const SECRET_PATTERNS = [
  ...
  },
  {
    name: 'GitHub Tokens',
    pattern:
      /(ghp_[a-zA-Z0-9]{36}|gho_[a-zA-Z0-9]{36}|ghu_[a-zA-Z0-9]{36}|ghs_[a-zA-Z0-9]{36}|ghr_[a-zA-Z0-9]{36})/gi,
    severity: 'high',
  },
  {
    name: 'Slack Tokens',
  ...
  },
  {
    ...
    pattern:
      /(secret|password|passwd|pwd)\s*[:=]\s*['"]?([a-zA-Z0-9!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]{8,})['"]?/gi,
    severity: 'medium',
  },
];
...
function main() {
  try {
    ...
    results.summary.status =
      results.summary.criticalFindings + results.summary.highFindings === 0 ? 'PASS' : 'FAIL';
